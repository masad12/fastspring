...
from ctexaa import Ctexaa, AsyncCtexaa, APIResponseValidationError
from ctexaa._types import Omit
from ctexaa._models import BaseModel, FinalRequestOptions
from ctexaa._exceptions import CtexaaError, APIStatusError, APITimeoutError, APIResponseValidationError
from ctexaa._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: Ctexaa | AsyncCtexaa) -> int:
...
class TestCtexaa:
    client = Ctexaa(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_client_timeout_option(self) -> None:
        client = Ctexaa(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CtexaaError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = Ctexaa(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Ctexaa) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Ctexaa(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(CTEXAA_BASE_URL="http://localhost:5000/from/env"):
            client = Ctexaa(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Ctexaa(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Ctexaa(
    ...
    def test_base_url_trailing_slash(self, client: Ctexaa) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Ctexaa) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Ctexaa) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Ctexaa(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Ctexaa(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Ctexaa(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("ctexaa._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Ctexaa) -> None:
    ...
    @mock.patch("ctexaa._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: Ctexaa) -> None:
    ...
    def test_omit_retry_count_header(
        self, client: Ctexaa, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncCtexaa:
    client = AsyncCtexaa(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(CtexaaError):
            with update_env(**{"PETSTORE_API_KEY": Omit()}):
                client2 = AsyncCtexaa(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncCtexaa) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(CTEXAA_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncCtexaa(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncCtexaa) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncCtexaa) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncCtexaa) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncCtexaa(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncCtexaa(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    @mock.patch("ctexaa._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncCtexaa) -> None:
        respx_mock.get("/store/inventory").mock(side_effect=httpx.TimeoutException("Test timeout error"))
    ...
    @mock.patch("ctexaa._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    async def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncCtexaa) -> None:
        respx_mock.get("/store/inventory").mock(return_value=httpx.Response(500))
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncCtexaa, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from ctexaa._utils import asyncify
        from ctexaa._base_client import get_platform
