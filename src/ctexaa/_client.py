...
from ._exceptions import CtexaaError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Ctexaa", "AsyncCtexaa", "Client", "AsyncClient"]


class Ctexaa(SyncAPIClient):
    pets: pets.PetsResource
    store: store.StoreResource
    users: users.UsersResource
    with_raw_response: CtexaaWithRawResponse
    with_streaming_response: CtexaaWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Ctexaa client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("CTEXAA_BASE_URL")
        if base_url is None:
        ...
        self.with_raw_response = CtexaaWithRawResponse(self)
        self.with_streaming_response = CtexaaWithStreamedResponse(self)
...
class AsyncCtexaa(AsyncAPIClient):
    pets: pets.AsyncPetsResource
    store: store.AsyncStoreResource
    users: users.AsyncUsersResource
    with_raw_response: AsyncCtexaaWithRawResponse
    with_streaming_response: AsyncCtexaaWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncCtexaa client instance.
        ...
        self.with_raw_response = AsyncCtexaaWithRawResponse(self)
        self.with_streaming_response = AsyncCtexaaWithStreamedResponse(self)
...
class CtexaaWithRawResponse:
    def __init__(self, client: Ctexaa) -> None:
...
class AsyncCtexaaWithRawResponse:
    def __init__(self, client: AsyncCtexaa) -> None:
...
class CtexaaWithStreamedResponse:
    def __init__(self, client: Ctexaa) -> None:
...
class AsyncCtexaaWithStreamedResponse:
    def __init__(self, client: AsyncCtexaa) -> None:
